...
class NLM_Partial_ConvNet(nn.Module):
    ...
    def __init__(self, input_size=144, layers=4):
        ...
        self.Non_Local_Module_1 = NONLocalBlock2D(256, sub_sample=True, bn_layer=True)
        self.Non_Local_Module_2 = NONLocalBlock2D(512, sub_sample=True, bn_layer=True)
        self.Non_Local_Module_3 = NONLocalBlock2D(512, sub_sample=True, bn_layer=True)
    ...
    def forward(self, input_x, mask):
        ...
        buffer_attention,out = self.Non_Local_Module_1(out)
        buffer_1 = out.clone()
