...
class my_own_skip_net(nn.Module):
    ...
    def forward(self, inMask, x, return_attns=False):
        ...
        x_after_d_3 = x_after_d_3.reshape((bs,18,18,128))  
        ...
        updated_feature_map = batch_NLM(masked_feature_map, x_after_d_3, h_gaussian)
        
    
        res_3 = updated_feature_map.cuda()
        
        x_after_d_4 = self.d_4(updated_feature_map.cuda())
